...
`,Rv=()=>d(Ov,{className:"wrapper-background",children:d("div",{className:"container",children:d("div",{className:"newsletter-section",children:O("div",{className:"newsletter-content",children:[d("span",{className:"small-text",children:"Newsletter"}),d("span",{className:"big-text testdatat",children:"Sign up for latest updates and offers"}),O("div",{className:"form",children:[d("input",{type:"text",placeholder:"Email Address"}),d("button",{className:"newsletter-btn",children:"Subscribe"})]}),d("div",{className:"text testdata",children:"Will be used in accordance with our Privacy Policy"}),O("div",{className:"social-icons",children:[d("div",{className:"icon",children:d(yv,{size:14})}),d("div",{className:"icon",children:d(Sv,{size:14})}),d("div",{className:"icon",children:d(wv,{size:14})}),d("div",{className:"icon",children:d(xv,{size:14})})]})]})})})}),Ov=Ve.section`
  .newsletter-section {
    width: 100%;
    display: flex;
    align-items: center;
