...
`,X=[{id:1,imgsrc:"/images/blog-img-1.jpg",pname:"Cheezy Pizza Toppins",price:"Mauris fermentum dictum magna. Sed laoreet ali­quam leo. Ut tellus dolor, dapibus eget, elementum vel, cursus eleifend, elit."},{id:2,imgsrc:"/images/blog-img-2.jpg",pname:"Cheezy Pizza Toppins",price:"Mauris fermentum dictum magna. Sed laoreet ali­quam leo. Ut tellus dolor, dapibus eget, elementum vel, cursus eleifend, elit."},{id:3,imgsrc:"/images/blog-img-3.jpg",pname:"Cheezy Pizza Toppins",price:"Mauris fermentum dictum magna. Sed laoreet ali­quam leo. Ut tellus dolor, dapibus eget, elementum vel, cursus eleifend, elit."},{id:4,imgsrc:"/images/blog-img-4.jpg",pname:"Cheezy Pizza Toppins",price:"Mauris fermentum dictum magna. Sed laoreet ali­quam leo. Ut tellus dolor, dapibus eget, elementum vel, cursus eleifend, elit."},{id:5,imgsrc:"/images/blog-img-5.jpg",pname:"Cheezy Pizza Toppins",price:"Mauris fermentum dictum magna. Sed laoreet ali­quam leo. Ut tellus dolor, dapibus eget, elementum vel, cursus eleifend, elit."},{id:6,imgsrc:"/images/blog-img-6.jpg",pname:"Cheezy Pizza Toppins",price:"Mauris fermentum dictum magna. Sed laoreet ali­quam leo. Ut tellus dolor, dapibus eget, elementum vel, cursus eleifend, elit."},{id:7,imgsrc:"/images/blog-img-7.jpg",pname:"Cheezy Pizza Toppins",price:"Mauris fermentum dictum magna. Sed laoreet ali­quam leo. Ut tellus dolor, dapibus eget, elementum vel, cursus eleifend, elit."},{id:8,imgsrc:"/images/blog-img-8.jpg",pname:"Cheezy Pizza Toppins",price:"Mauris fermentum dictum magna. Sed laoreet ali­quam leo. Ut tellus dolor, dapibus eget, elementum vel, cursus eleifend, elit."},{id:9,imgsrc:"/images/blog-img-9.jpg",pname:"Cheezy Pizza Toppins",price:"Mauris fermentum dictum magna. Sed laoreet ali­quam leo. Ut tellus dolor, dapibus eget, elementum vel, cursus eleifend, elit."},{id:10,imgsrc:"/images/blog-img-10.jpg",pname:"Cheezy Pizza Toppins",price:"Mauris fermentum dictum magna. Sed laoreet ali­quam leo. Ut tellus dolor, dapibus eget, elementum vel, cursus eleifend, elit."},{id:11,imgsrc:"/images/blog-img-11.jpg",pname:"Cheezy Pizza Toppins",price:"Mauris fermentum dictum magna. Sed laoreet ali­quam leo. Ut tellus dolor, dapibus eget, elementum vel, cursus eleifend, elit."},{id:12,imgsrc:"/images/blog-img-12.jpg",pname:"Cheezy Pizza Toppins",price:"Mauris fermentum dictum magna. Sed laoreet ali­quam leo. Ut tellus dolor, dapibus eget, elementum vel, cursus eleifend, elit."}],mv=()=>O(hv,{children:[O("h1",{className:"blog-heading wrapper-background",children:["Read ",d("span",{className:"blog-sub-heading",children:"Our Blogs"})]}),d("div",{className:"container",children:d("div",{className:"blog-container",children:O("div",{className:"blogs",children:[d(gt,{id:X[0].id,imgsrc:X[0].imgsrc,pname:X[0].pname,price:X[0].price}),d(gt,{id:X[1].id,imgsrc:X[1].imgsrc,pname:X[1].pname,price:X[1].price}),d(gt,{id:X[2].id,imgsrc:X[2].imgsrc,pname:X[2].pname,price:X[2].price}),d(gt,{id:X[3].id,imgsrc:X[3].imgsrc,pname:X[3].pname,price:X[3].price}),d(gt,{id:X[4].id,imgsrc:X[4].imgsrc,pname:X[4].pname,price:X[4].price}),d(gt,{id:X[5].id,imgsrc:X[5].imgsrc,pname:X[5].pname,price:X[5].price}),d(gt,{id:X[6].id,imgsrc:X[6].imgsrc,pname:X[6].pname,price:X[6].price}),d(gt,{id:X[7].id,imgsrc:X[7].imgsrc,pname:X[7].pname,price:X[7].price}),d(gt,{id:X[8].id,imgsrc:X[8].imgsrc,pname:X[8].pname,price:X[8].price}),d(gt,{id:X[9].id,imgsrc:X[9].imgsrc,pname:X[9].pname,price:X[9].price}),d(gt,{id:X[10].id,imgsrc:X[10].imgsrc,pname:X[10].pname,price:X[10].price}),d(gt,{id:X[11].id,imgsrc:X[11].imgsrc,pname:X[11].pname,price:X[11].price})]})})})]}),hv=Ve.section`
  .blog-heading {
    text-transform: uppercase;
    font-size: 3rem;
    text-align: center;
...
`,gv=()=>d(vv,{children:d("div",{className:"menuIcon",children:O("ul",{className:"navbar-list",children:[d("li",{children:d(jt,{className:"navbar-link",to:"/",children:"Home"})}),d("li",{children:d(jt,{className:"navbar-link",to:"/menu",children:"Menu"})}),d("li",{children:d(jt,{className:"navbar-link",to:"/blog",children:"Blog"})}),d("li",{children:d(jt,{className:"navbar-link",to:"/about",children:"About"})}),d("li",{children:d(jt,{className:"navbar-link",to:"/contact",children:"Contact"})}),d("li",{children:d(jt,{className:"navbar-link",to:"/account",children:"Account"})})]})})}),vv=Ve.nav`
  .navbar-list {
    list-style: none;
    display: none;
    gap: 4.2rem;
...
`,Rv=()=>d(Ov,{className:"wrapper-background",children:d("div",{className:"container",children:d("div",{className:"newsletter-section",children:O("div",{className:"newsletter-content",children:[d("span",{className:"small-text",children:"Newsletter"}),d("span",{className:"big-text",children:"Sign up for latest updates and offers"}),O("div",{className:"form",children:[d("input",{type:"text",placeholder:"Email Address"}),d("button",{className:"newsletter-btn",children:"Subscribe"})]}),d("div",{className:"text",children:"Will be used in accordance with our Privacy Policy"}),O("div",{className:"social-icons",children:[d("div",{className:"icon",children:d(yv,{size:14})}),d("div",{className:"icon",children:d(Sv,{size:14})}),d("div",{className:"icon",children:d(wv,{size:14})}),d("div",{className:"icon",children:d(xv,{size:14})})]})]})})})}),Ov=Ve.section`
  .newsletter-section {
    width: 100%;
    display: flex;
    align-items: center;
